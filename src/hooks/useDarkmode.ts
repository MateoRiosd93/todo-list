...
const getInitialState = () => {
    const VALIDATION_THEME = (localStorage.getItem(DarkMode.theme) === DarkMode.dark) ||
        (!(DarkMode.theme in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)
